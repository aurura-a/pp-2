...
erasor = pygame.transform.scale(
    pygame.image.load("paint_folder/eraser.png"), (40, 40))
    ...
    while True:
        ...
        if e.type == pygame.KEYDOWN:
            ...
            if e.key == pygame.K_1:
                rect_size = 100
                pygame.draw.rect(
                    screen, color, (spot[0], spot[1], rect_size, rect_size+100))
            elif e.key == pygame.K_2:
                circle_radius = 50
                pygame.draw.circle(
                    screen, color, (spot[0], spot[1]), circle_radius)
            elif e.key == pygame.K_3:
                square_size = 100
                pygame.draw.rect(
                    screen, color, (spot[0], spot[1], square_size, square_size))
            elif e.key == pygame.K_4:
                triangle_size = 50
                pygame.draw.polygon(screen, color, [(
                    spot[0], spot[1]), (spot[0] + triangle_size, spot[1]), (spot[0], spot[1] + triangle_size)])
            elif e.key == pygame.K_5:
                pygame.draw.polygon(screen, color, [(
                    spot[0], spot[1]), (spot[0] - 50, spot[1] + 100), (spot[0] + 50, spot[1] + 100)])
            elif e.key == pygame.K_6:
                pygame.draw.polygon(screen, color, [
                    (spot[0], spot[1] - 50),  # вершина сверху
                    (spot[0] + 50, spot[1]),  # вершина справа
                    (spot[0], spot[1] + 50),  # вершина снизу
                    (spot[0] - 50, spot[1])   # вершина слева
                ])
